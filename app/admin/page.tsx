          ...
          {finTab==='usuario'&&(
            <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px'}}>
                ...
                <div><div style={{display:'flex',alignItems:'center',gap:'5px',marginBottom:'5px'}}><label style={{...LabelStyle,marginBottom:0}}>Saque Automático até (R$)</label><AdminTip text="Saques com valor igual ou inferior a este limite são aprovados automaticamente. Defina 0 para exigir aprovação manual em todos os saques." pos="bottom"/></div><input type="number" min="0" step="0.01" placeholder="0" value={local.auto_withdraw_limit||''} onChange={upd('auto_withdraw_limit')} style={InputStyle}/></div>
              </div>
...
const PRESETS = [
  ...
  { label:'Laranja Queimado',   desc:'Paleta quente com tons terrosos',                       colors:{'--background':'#1a0f08','--foreground':'#f8f0e8','--card':'#221508','--surface':'#0f0905','--muted':'#38240f','--muted-foreground':'#888888','--border':'#3d2a10','--primary':'#e27b30','--destructive':'#ef4444'} },
  { label:'Rosa Elegante',      desc:'Tons rosados sofisticados e femininos',                 colors:{'--background':'#1a0a12','--foreground':'#fff0f8','--card':'#22101a','--surface':'#0f060a','--muted':'#381825','--muted-foreground':'#888888','--border':'#3d2030','--primary':'#e54d8a','--destructive':'#ef4444'} },
  { label:'Ciano Tecnológico',  desc:'Visual futurista com tons de ciano',                   colors:{'--background':'#050e10','--foreground':'#f0fbff','--card':'#08161a','--surface':'#030709','--muted':'#0d2a35','--muted-foreground':'#888888','--border':'#10384a','--primary':'#00d4e8','--destructive':'#ef4444'} },
  { label:'Âmbar Dourado',      desc:'Tons dourados e âmbar para um visual premium',          colors:{'--background':'#18120a','--foreground':'#fff8e8','--card':'#22180a','--surface':'#0e0c06','--muted':'#382c10','--muted-foreground':'#888888','--border':'#40320f','--primary':'#f0a800','--destructive':'#ef4444'} },
  { label:'Vermelho Borgonha',  desc:'Tons profundos de vermelho e bordô',                   colors:{'--background':'#180808','--foreground':'#fff0f0','--card':'#220c0c','--surface':'#0e0505','--muted':'#381515','--muted-foreground':'#888888','--border':'#401515','--primary':'#c0233c','--destructive':'#ff6b6b'} },
  { label:'Verde Floresta',     desc:'Tons naturais de verde escuro',                        colors:{'--background':'#0a120c','--foreground':'#f0f5f1','--card':'#0e1a10','--surface':'#060a07','--muted':'#182e1c','--muted-foreground':'#888888','--border':'#20381f','--primary':'#2d9e4a','--destructive':'#ef4444'} },
  { label:'Cinza Neutro',       desc:'Tema minimalista em tons de cinza',                    colors:{'--background':'#111112','--foreground':'#f0f0f2','--card':'#1a1a1c','--surface':'#080809','--muted':'#2a2a2e','--muted-foreground':'#888888','--border':'#303038','--primary':'#8080ff','--destructive':'#ef4444'} },
  { label:'Violeta Místico',    desc:'Tons profundos de violeta e púrpura',                  colors:{'--background':'#0e0818','--foreground':'#f8f4ff','--card':'#130d22','--surface':'#07040e','--muted':'#221840','--muted-foreground':'#888888','--border':'#2a1e48','--primary':'#b56aff','--destructive':'#ef4444'} },
  { label:'Índigo Profundo',    desc:'Azul índigo sofisticado e moderno',                    colors:{'--background':'#090a1a','--foreground':'#f0f2ff','--card':'#0c0e26','--surface':'#05060f','--muted':'#141a48','--muted-foreground':'#888888','--border':'#182250','--primary':'#5c6fff','--destructive':'#ef4444'} },
  { label:'Marrom Chocolate',   desc:'Tons terrosos e acolhedores de marrom',                colors:{'--background':'#160e08','--foreground':'#f8f0e4','--card':'#201408','--surface':'#0b0704','--muted':'#382618','--muted-foreground':'#888888','--border':'#3d2c18','--primary':'#c07820','--destructive':'#ef4444'} },
  { label:'Esmeralda Luxo',     desc:'Verde esmeralda rico e elegante',                      colors:{'--background':'#061412','--foreground':'#f0fff8','--card':'#081e1c','--surface':'#030a09','--muted':'#0c3834','--muted-foreground':'#888888','--border':'#104438','--primary':'#00c896','--destructive':'#ef4444'} },
  { label:'Safira Real',        desc:'Azul safira nobre e majestoso',                        colors:{'--background':'#070d1e','--foreground':'#f0f4ff','--card':'#0a1228','--surface':'#040710','--muted':'#122248','--muted-foreground':'#888888','--border':'#162c58','--primary':'#2060e8','--destructive':'#ef4444'} },
  { label:'Coral Tropical',     desc:'Tons vibrantes de coral e salmão',                     colors:{'--background':'#1a0e0c','--foreground':'#fff4f0','--card':'#22130e','--surface':'#0e0706','--muted':'#3c2218','--muted-foreground':'#888888','--border':'#402820','--primary':'#ff6040','--destructive':'#ef4444'} },
]
